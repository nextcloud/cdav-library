...
describe('Request', () => {
	...
	it('should reject the promise on abort', async () => {
		...
		const request = new Request('https://nextcloud.testing/nextcloud/remote.php/dav/', parser)
		// TODO: improve testing signal.aborted flag
		// expect(signal.aborted).toEqual(false)
		setTimeout(() => { abortController.abort() }, 100)
		const response = await request.get('fooBar', {}, null, null, null, { signal }).catch(e => e)
		...
		expect(response).toEqual(expect.any(NetworkRequestAbortedError))
